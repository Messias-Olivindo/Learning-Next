...
export const FeatureSection = () => {
  return (
    ...
    <div className="col-span-full flex flex-col gap-2">
        ...
        <div className="grid gird-cols-1 md:grid-cols-2 gap-12 md:gap-4 rounded-lg bg-gray-500 p-6 md:p-12">
            <div className="flex flex-col gap-4 ">
                ...
                <Button asChild className="hidden w-fit rounded-full mt-4 md:mt-auto md:flex">
            ...
            <div className="flex flex-col items-center justify-center w-full">
                ...
                <Button asChild className="w-full gap-2 md:hidden rounded-full mt-4 md:mt-auto">
                    <Link href="/criar-loja">
                        Criar loja grátis
                        <ArrowRight />
                    </Link>
