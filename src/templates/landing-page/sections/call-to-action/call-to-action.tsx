...
export const CallToAction = () => {
  return (
    <section className="relative py-24 bg-gradient-to-b from-cyan-950/20 to-gray-700">
      <div className="absolute inset-0 hidden md:block bg-[url('/background-footer.svg')] bg-center bg-cover bg-no-repeat opacity-90" />
      ...
      <div className="container relative">
        <div className="flex flex-col items-center gap-6 text-center ">
          ...
          <Button variant="primary" asChild className="mt-6">
            <Link href="/criar-loja" className="text-white">
              Criar loja grátis
              <ArrowRight />
            </Link>
          </Button>
